...
const RoomsPage = () => {
    ...
    if (loading) return <div className="p-10 text-center text-white">Loading rooms...</div>;
            ...
            <main className="flex-1 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 items-stretch">
                {filteredRooms.map((room) => {
                    ...
                    return (
                        <div
                            key={room._id}
                            className="bg-[#1E2937] rounded-lg shadow hover:shadow-lg hover:scale-105 transition-all duration-300 ease-in-out overflow-hidden"
                        >
                            <Image
                                src={room.image}
                                alt={room.name}
                            ...
                            <div className="p-4 flex flex-col flex-grow">
                                ...
                                <div className="mt-2 flex flex-wrap gap-2">
                                    {Array.isArray(room.amenities)
                                        ...
                                        : room.amenities && (
                                            <span className="text-xs bg-teal-700 px-2 py-1 rounded-full text-white font-semibold  ">
                                                {room.amenities}
                                            </span>
                                        )
                                    }
